  ...
  if (primary) {
    ...
    for (const d of primary.disputed || []) {
      if (d?.correction) {
        ...
        // these disputes reflect real problems rather than context gaps, so we
        // remove the offending line entirely instead of merely demoting its link.
    ...
    // unflagged, ungrounded claim in the prose.
