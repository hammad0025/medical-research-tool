...
const isPubMedSearchUrl = (url) => PUBMED_SEARCH_RE.test(String(url || ''));
const isClinicalTrialsSearchUrl = (url) => CT_SEARCH_RE.test(String(url || ''));
