...
// padding (see api/research.js). 3 lanes × 7 = 21 raw, trimmed to the soft cap.
export const REPURPOSE_PER_LANE = 7;
// Soft cap on the FINAL curated list after grounding gate + ranking + dedup.
// "Up to 20 grounded candidates" — quantity is an output of the quality gate,
// not a hard quota.
export const REPURPOSE_TARGET_TOTAL = 20;
export const REPURPOSE_SOFT_CAP = 20;
