...
// Diversity fan-out, not a quota: each lane may return up to eight supported
// candidates split across the two patient-facing sections.
export const REPURPOSE_PER_LANE = 8;
...
export const resolveRepurposeSection = (blockOrFields = {}) => {
  ...
  if (tagged.includes('never') || tagged.includes('no-condition')) return REPURPOSE_SECTION_NEVER;
