...
const PROHIBITED_SKELETONS = [
  'evidencepack', 'k8', 'diligencepacket', 'demorehearsal', 'challengesuite',
...
export const APPROVED_PUBLIC_VOCABULARY = Object.freeze({
  ...
  'degraded': 'partial source coverage',
...
export const canonicalizePublicUnicode = (value) =>
...
const RAW_LABELS = Object.freeze({
  PROVIDER: 'Treatment type',
  TREATMENT: 'Treatment',
  FDA_STATUS: 'FDA status',
...
const REWRITES = [
  ...
  [/\bsource SHA\b/gi, 'reviewed version'],
...
export const rewritePublicLanguage = (value, { sourceTitle = false } = {}) => {
...
export const assertPublicLanguage = (value, options) => {
