...
export function detectValidationMismatch(validation, userCondition = '') {
  ...
  return {
    ...
    overallScore: score,
    headline: 'The second AI thinks this report may be about the wrong condition.',
    summary: p.overall || 'The second AI flagged possible confusion about which condition this report covers.',
