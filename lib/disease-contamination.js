 ...
 * ever see them. Curated KB for the matched condition is kept. Live hits that
 * name a foreign disease OR fail sourceMentionsCondition are dropped.
 */
export const filterEvidencePackByCondition = (items, patientCondition = '') => {
  ...
  for (const a of items) {
    ...
    // Curated KB for this condition — always keep (already matched by loadKb).
    if (a.isCuratedKB) {
      kept.push(a);
      continue;
    }
