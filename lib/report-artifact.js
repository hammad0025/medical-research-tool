...
import { isPlainObject, stableValue } from './stable-serialize.js';

const REPORT_OUTPUT_PURPOSE = 'report-output.artifact';
...
const verifyReportOutputArtifact = (artifact, options = {}) => {
