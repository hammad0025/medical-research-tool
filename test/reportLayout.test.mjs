...
test('the patient-first report flow keeps practical decisions ahead of the full trial directory', () => {
  ...
  assert.match(appSource, /Unresearched ideas for this illness/)
  assert.match(appSource, /Unresearched for this illness/)
  ...
  assert.match(appSource, /New idea to check/)
