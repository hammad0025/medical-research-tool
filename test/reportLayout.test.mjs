...
test('the patient-first report flow keeps practical decisions ahead of the full trial directory', () => {
  ...
  assert.match(appSource, /Not researched for this condition/)
  assert.match(appSource, /Not researched for this condition/)
  assert.match(appSource, /What this means/)
  assert.match(appSource, /Name to discuss/)
  ...
  assert.match(appSource, /Why this is on the list/)
  assert.match(appSource, /AI idea to check/)
  assert.doesNotMatch(appSource, /Animal or lab research/)
  ...
  assert.match(appSource, /\\b\(\?:placebo\|sham\)\\b/)
  assert.match(appSource, /replace\(\/\^phase\\s\*\\d\+/)
  ...
  assert.match(appSource, /const specialistForCondition/)
  assert.match(appSource, /return 'diabetes specialist'/)
  assert.match(appSource, /specialistForCondition\(condition\)/)
  assert.doesNotMatch(appSource, /A retinal specialist can explain the result, limits, and whether it matters now\./)
